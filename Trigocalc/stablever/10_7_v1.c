...
void DrawState()
{
    ...
    } else if (currentState == 1)
    {
        ...
        while (1)
        {
            ...
            else if (key && ((key >= 0x0030 && key <= 0x0039) || (key == 0x02E && selectionCursor < 4)))
            {   
